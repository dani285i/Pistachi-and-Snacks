                        ...
                        <form onSubmit={handleSubmitProducto} className="admin-form">
                            ...
                            <div className="form-row">
                                <div className="form-group flex-1">
                                    ...
                                    <div className="number-input-wrapper" style={isStockInvalid ? { border: '1px solid #E74C3C', borderRadius: '12px', overflow: 'hidden' } : {}}>
                                        <input required type="number" min="0" step="1" value={formData.stock} onChange={e => setFormData({...formData, stock: e.target.value === '' ? '' as any : parseInt(e.target.value)})} onBlur={() => setFormData({...formData, stock: (formData.stock as any) === '' || isNaN(formData.stock as any) ? 0 : formData.stock})} placeholder="Ej: 10" style={isStockInvalid ? { color: '#E74C3C' } : {}} />
                            ...
                            <div className="form-row">
                                <div className="form-group flex-1">
                                    ...
                                    <div className="number-input-wrapper">
                                        <input required type="number" step="0.01" value={formData.precio} onChange={e => setFormData({...formData, precio: e.target.value === '' ? '' as any : parseFloat(e.target.value)})} onBlur={() => setFormData({...formData, precio: (formData.precio as any) === '' || isNaN(formData.precio as any) ? 0 : formData.precio})} placeholder="0.00" />
                                        <div className="spinner-controls">
                            ...
                            <div className="form-row">
                                <div className="form-group flex-1">
                                    ...
                                    <div className="number-input-wrapper">
                                        <input required type="number" min="1" step="1" value={formData.unidades} onChange={e => setFormData({...formData, unidades: e.target.value === '' ? '' as any : parseInt(e.target.value)})} onBlur={() => setFormData({...formData, unidades: (formData.unidades as any) === '' || isNaN(formData.unidades as any) ? 1 : formData.unidades})} placeholder="Ej: 5" />
                                        <div className="spinner-controls">
